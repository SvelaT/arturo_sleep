...
gen1Values = (1:2:32)*1;%number hidden neurons
...
populationSize = 20;
numElitism = 2;
mutationRate = [ones(1,5)*0.1,ones(1,5)*0.09,ones(1,5)*0.08,ones(1,5)*0.07,ones(1,5)*0.06,ones(1,5)*0.05,ones(1,5)*0.04,ones(1,5)*0.03,ones(1,10)*0.02];
nTournament = 5;
npoints = 2;
percCross = 0.9;
...
[best_chromossome,best_fitness,populations,fitnesses] = geneticalgorithm(numberOfVariables,populationSize,@FitnessFunction,percCross,numElitism,mutationRate,nGenerations,nTournament,npoints);
